...
class WaterFeesLog(models.Model):
    ...
    水费使用记录
    """
    dormitory = models.ForeignKey(Dormitory, verbose_name="宿舍", on_delete=models.CASCADE, related_name='water_fees_log_s_dormitory')
    ...
    operator = models.ForeignKey(User, verbose_name="操作人", on_delete=models.CASCADE, related_name='water_fees_log_s_operator')
...
class ElectricityFeesLog(models.Model):
    ...
    电费使用记录
    """
    dormitory = models.ForeignKey(Dormitory, verbose_name="宿舍", on_delete=models.CASCADE, related_name='electricity_fees_log_s_dormitory')
    mode = models.CharField(verbose_name="操作方式", max_length=3, choices=(("add", "加"), ("sub", "减")), default="sub")
    change_money = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="改变金额(元)")
    operator = models.ForeignKey(User, verbose_name="操作人", on_delete=models.CASCADE, related_name='electricity_fees_log_s_operator')
    add_time = models.DateTimeField(verbose_name="创建时间", default=datetime.now)
    note = models.CharField(verbose_name="备注", max_length=100, blank=True, null=True)
...
class FeesRechargeOrder(models.Model):
    ...
    充值订单
    """
    operator = models.ForeignKey(User, verbose_name="操作人", on_delete=models.CASCADE, related_name='fees_recharge_order_s_operator')
    price = models.IntegerField(verbose_name="充值金额(元)")
    recharge_dormitory = models.ForeignKey(Dormitory, verbose_name="宿舍", on_delete=models.CASCADE, related_name='fees_recharge_order_s_dormitory')
    ...
    pay_no = models.CharField(verbose_name="充值流水号(支付平台订单号)", max_length=100, blank=True, null=True)
...
class Repair(models.Model):
    ...
    applicant = models.ForeignKey(User, verbose_name="申请人", on_delete=models.CASCADE, related_name='repair_s_applicant')
    dormitory = models.ForeignKey(Dormitory, verbose_name="宿舍", on_delete=models.CASCADE, related_name='repair_s_dormitory')
...
class RepairLog(models.Model):
    ...
    宿舍 报修单 回复
    """
    main_repair = models.ForeignKey(Repair, verbose_name="主报修单", on_delete=models.CASCADE, related_name='repair_log_s_main_repair')
    ...
    reply_person = models.ForeignKey(User, verbose_name="回复人", on_delete=models.CASCADE, related_name='repair_log_s_reply_person')
    add_time = models.DateTimeField(verbose_name="创建时间", default=datetime.now)
