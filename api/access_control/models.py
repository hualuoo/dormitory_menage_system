...
class AccessControl(models.Model):
    ...
    person = models.ForeignKey(User, verbose_name="通过的人", on_delete=models.CASCADE, related_name='access_control_s_person')
...
class AccessControlAbnormalApplication(models.Model):
    ...
    门禁记录 识别异常申请
    """
    main_record = models.OneToOneField(AccessControl, verbose_name="主记录", on_delete=models.CASCADE, related_name='abnormal_application')
