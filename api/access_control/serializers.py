...
class AccessControlSerializer(serializers.ModelSerializer):
    ...
    status = serializers.ChoiceField(help_text="状态", choices=(("normal", "正常"), ("later", "晚归"), ("abnormal", "异常")), default="normal")
    ...
    class Meta:
        model = AccessControl
        fields = ("id", "photo", "person__username", "person__first_name", "person__last_name", "person__face__photo", "status", "accuracy", "add_time", )
